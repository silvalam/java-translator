...
public class Scan {
	...
	while(true) {
		...
		switch( c ) {
		    case '^':
		    return ccase1('^', TK.STARTFOR); // added to account for new '^' terminal
		    case '$':
		    return ccase1('$', TK.ENDFOR); // added to account for new '$' terminal
		    case '&':
		    return ccase1('&', TK.FOR); // added to account for new '&' terminal
		    case '=':
		    return ccase1('=', TK.ASSIGN); // added to account for '=' terminal
		    case '>':
		    return ccase1('>', TK.ENDDO); // added to account for '>' terminal
		    case '~':
		    return ccase1('~', TK.TILDE); // added to account for '~' terminal
		    case '@':
